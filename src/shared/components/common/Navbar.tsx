            ...
            <div className="flex items-center gap-1 lg:gap-4">
              ...
              <div className="">
                <div ref={cityRef} className="relative">
                  <button
                    className="bg-white text-gray-700 px-4 lg:py-2 py-1 rounded-xl hover:bg-gray-50 transition-all duration-200 flex items-center gap-2 shadow-lg whitespace-nowrap shrink-0"
                  ...
                  >
                    ...
                    <svg className={`w-4 h-4 shrink-0 transition-transform duration-200 ${cityDropdownOpen ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
