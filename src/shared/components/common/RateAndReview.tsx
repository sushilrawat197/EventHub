...
import { ratingAndReview } from "@/features/orders/services/orders.service";
...
export default function RateAndReview() {
  ...
  return (
    <div className="min-h-[calc(100vh-6rem)] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <motion.div
