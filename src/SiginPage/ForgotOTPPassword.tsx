                  ...
                  <OtpInput
                    ...
                    renderInput={(props) => (
                      <input
                        {...props}
                        placeholder="-"
                        className="w-12 h-14 text-center border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg font-semibold bg-gray-50 focus:bg-white transition-all duration-300"
                      />
                    )}
                    containerStyle={{
