                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                            selectedMethod === "Mpesa" ? "bg-blue-100" : "bg-gray-100"
                          }`}>
                            <FaWallet className={`text-xl ${
                              selectedMethod === "Mpesa" ? "text-blue-600" : "text-gray-600"
                            }`} />
                          </div>
                          <div>
                            <h3 className="text-base font-bold text-gray-900">Mobile Wallet</h3>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-xs text-gray-700">
                            <span className="font-semibold text-blue-600">Securely save Number.</span>{" "}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 mb-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-900 text-sm">English</span>
                  </div>
                </div>
              </div>
