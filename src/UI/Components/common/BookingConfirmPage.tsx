...
export default function BookingConfirmed() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex flex-col items-center p-4 sm:p-6 mt-16 lg:mt-28">
      {/* Header Confirmation */}
      <div className="w-full max-w-6xl bg-white shadow-xl rounded-xl p-4 sm:p-5 mb-4 flex items-center justify-center border border-gray-100">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-5">
        ...
        {/* RIGHT SECTION */}
        <div className="w-full lg:w-96 bg-white shadow-xl rounded-xl p-4 sm:p-5 border border-gray-100">
          <div>
            ...
            <div className="flex flex-col gap-2">
              <div className="fle justify-between text-xs bg-orange-50 p-2 rounded-lg ">
              ...
              <div className="flex justify-between text-xs bg-orange-50 p-2 rounded-lg">
                <span className="font-semibold">Responsedesc</span>
              ...
              <div className="flex justify-between text-xs  bg-orange-50 p-2 rounded-lg">
                ...
                <span className="font-bold">
                  {confirmBookingDetails?.payment?.transactionRef}
                </span>
              </div>
            </div>
          </div>

          <h3 className="text-sm font-bold text-gray-900 mb-3 pt-5">
            Payment Summary
          </h3>
