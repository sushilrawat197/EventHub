const PosterRanking = () => {
  return (
    <section className="bg-gradient-to-r from-sky-500 via-sky-400 to-sky-300 text-white py-10 mt-15 ">
      <div className="max-w-6xl mx-auto px-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
        {/* Organizers */}
        <div>
